...
const PLATFORM = "firefox-extension";
const DEFAULT_POLL_MINUTES = 3;
const DEFAULT_ROOT_ID = "unfiled_____";
const ROOT_ID = "root________";
const BOOKMARK_MENU_ID = "menu________";
const BOOKMARK_TOOLBAR_ID = "toolbar_____";
const MOBILE_BOOKMARKS_ID = "mobile______";

const SPECIAL_ROOT_NAME_TO_ID = {
  "bookmarks menu": BOOKMARK_MENU_ID,
...
async function ensureClientId(state) {
  ...
  state.settings.clientId = `ff-${randomId()}`;
...
async function getLocalSpecialRootLookup() {
  ...
  for (const child of children) {
    ...
    if ([DEFAULT_ROOT_ID, BOOKMARK_MENU_ID, BOOKMARK_TOOLBAR_ID, MOBILE_BOOKMARKS_ID].includes(childId)) {
